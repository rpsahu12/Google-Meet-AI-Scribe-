...
async def join_meet_and_record(meet_url: str, bot_name: str = "AI Scribe Bot"):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Continuously scan the page for buttons that ONLY exist inside the actual meeting
            try:
                await page.wait_for_function('''
                    () => {
                        ...
                        return buttons.some(b => {
                            ...
                            return label && (label.includes('Leave call') || label.includes('Show everyone'));
                        });
                    }
                ''', timeout=60000)
                print("Successfully admitted to the meeting!")
            except Exception as e:
                print("Timeout: Bot was not admitted within 60 seconds.")
                return None  # Exit safely if not admitted
